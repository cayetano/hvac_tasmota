...
#define CODE_IMAGE_STR "TasmoCompiler-esp32generic"
  ...
  #undef STA_SSID1
#endif
#define STA_SSID1	"mi_reino"

#ifdef STA_PASS1
  #undef STA_PASS1
#endif
#define STA_PASS1	"Astrolabio929"

#ifdef WIFI_IP_ADDRESS
  #undef WIFI_IP_ADDRESS
#endif
#define WIFI_IP_ADDRESS	"192.168.168.123"
...
#define WIFI_SUBNETMASK	"255.255.255.0"
  ...
  #undef WIFI_GATEWAY
#endif
#define WIFI_GATEWAY	"192.168.168.1"

#ifdef WIFI_DNS
  #undef WIFI_DNS
#endif
#define WIFI_DNS	"192.168.168.14"
